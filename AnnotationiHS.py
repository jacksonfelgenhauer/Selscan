...
dict2 = pd.read_csv("./ExtremeJKN.csv")
...
for i in range(len(df)):
    ...
    df["Top SNP (position|iHS)"][i] = str(largest_position) + '|' + str(largest_score)
...
df.to_csv (r'./Result_JKN.csv', index = False, header=True)
